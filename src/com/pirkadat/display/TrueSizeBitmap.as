package com.pirkadat.display {
	...
	public class TrueSizeBitmap extends Bitmap implements ITrueSize
	{
		protected var internalLocation:Point = new Point();
		
		public function TrueSizeBitmap(bmd:BitmapData = null, pixelSnapping:String = 'auto', smoothing:Boolean = true)
		{
